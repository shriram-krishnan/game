...
explosionImage = pygame.image.load('images/explosionImage.png')
explosionRect = explosionImage.get_rect()
playerRect = playerImage.get_rect()
lifeImage = pygame.image.load('images/life.jpg')

# Set up the sounds.
shootSound = pygame.mixer.Sound('audios/shoot.wav')
explodeSound = pygame.mixer.Sound('audios/explosion.wav')
gameOverSound = pygame.mixer.Sound('audios/gameover.wav')
loseLifeSound = pygame.mixer.Sound('audios/loseLife.wav')
